...
(function($) {
	...
	var struct =(
		...
		'<tr>'+
		'<td class="h_t_l"></td>'+
		'<td class="h_t_c" title="déplacer"></td>'+
		'<td class="h_t_r"></td>'+
		'</tr>'+
		'<tr>'+
		'<td class="h_c_l"></td>'+
		'<td class="h_c_c">'+
		'<div class="piro_loader" title="fermer"><span></span></div>'+
		'<div class="resize">'+
		'<div class="nav_container">'+
		'<a href="#prev" class="piro_prev" title="précédente"></a>'+
		'<a href="#next" class="piro_next" title="suivante"></a>'+
		'<div class="piro_prev_fake">préc</div>'+
		'<div class="piro_next_fake">suiv</div>'+
		'<div class="piro_close" title="fermer"></div>'+
		'</div>'+
